...
all_labels = [
    ...
    'General caution','Dangerous curve to the left','Dangerous curve to the right','Double curve','Bumpy road',
...
st.write("Upload a traffic sign image to identify its meaning.")
...
if uploaded_file is not None:
    ...
    predicted_label = all_labels[pred_index]
